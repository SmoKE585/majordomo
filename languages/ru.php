...
$dictionary = array(
    ...
    'MODULE_SAVERESTORE' => 'Обновления системы',
    ...
    'ACTIONLOG_SOURCE' => 'Источник',
    'ACTIONLOG_MODULE' => 'Модуль',
    'ACTIONLOG_RESULT' => 'Результат',
    'ACTIONLOG_TARGET' => 'Объект',
    'ACTIONLOG_LOCATION' => 'Маршрут',
    'ACTIONLOG_REQUEST_METHOD' => 'Метод',
    'ACTIONLOG_SOURCE_ADMIN' => 'Панель управления',
    'ACTIONLOG_SOURCE_API' => 'API',
    'ACTIONLOG_SOURCE_WEB' => 'Веб',
    'ACTIONLOG_SOURCE_OBJECTS' => 'Objects API',
    'ACTIONLOG_SOURCE_COMMAND' => 'Командный endpoint',
    'ACTIONLOG_SOURCE_CLI' => 'CLI',
    'ACTIONLOG_RESULT_OK' => 'Успешно',
    'ACTIONLOG_RESULT_ERROR' => 'Ошибка',
    'ACTIONLOG_RESULT_SKIPPED' => 'Пропущено',
    'ACTIONLOG_ACTION_CONTROL_PANEL_ENTER' => 'Вход в панель управления',
    'ACTIONLOG_ACTION_CONTROL_PANEL_NAVIGATION' => 'Переход в панели управления',
    'ACTIONLOG_ACTION_CONTROL_PANEL_SUBMIT' => 'Сохранение формы в панели',
    'ACTIONLOG_ACTION_MARKET_INSTALL' => 'Установка дополнения',
    'ACTIONLOG_ACTION_MARKET_UPDATE' => 'Обновление дополнения',
    'ACTIONLOG_ACTION_MARKET_UNINSTALL' => 'Удаление дополнения',
    'ACTIONLOG_ACTION_MENU_CLICKED' => 'Нажатие команды меню',
    'ACTIONLOG_ACTION_SCENE_CLICKED' => 'Нажатие действия сцены',
    'ACTIONLOG_ACTION_SYSTEM_BACKUP' => 'Резервное копирование',
    'ACTIONLOG_ACTION_SYSTEM_UPDATE' => 'Обновление системы',
    'ACTIONLOG_ACTION_SYSTEM_RESTORE' => 'Восстановление системы',
    'ACTIONLOG_ACTION_DEVICE_CLICKED' => 'Нажатие устройства',
    'EXECUTED' => 'Выполнено',
...
//----
	...
	'MANDATORY_DB_BACKUP' => 'Резервная копия базы данных будет создана автоматически.',
